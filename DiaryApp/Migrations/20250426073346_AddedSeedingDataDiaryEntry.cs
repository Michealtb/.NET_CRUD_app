    ...
    public partial class AddedSeedingDataDiaryEntry : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Knocked out a 5 km run before sunrise—felt great!", new DateTime(2025, 4, 16, 3, 33, 46, 79, DateTimeKind.Local).AddTicks(7442), "Morning Jog" },
                    { 2, "Sketching vs. wireframing takeaways from today’s class.", new DateTime(2025, 4, 18, 3, 33, 46, 79, DateTimeKind.Local).AddTicks(7648), "UX Lecture Notes" },
